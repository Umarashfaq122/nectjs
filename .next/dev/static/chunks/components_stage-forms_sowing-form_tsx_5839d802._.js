...
function SowingForm() {
    ...
    const [filteredFarms, setFilteredFarms] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    /* ===================== FILTERING ===================== */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SowingForm.useEffect": ()=>{
            let results = [
                ...farmData
            ];
            ...
            if (selectedFarmNumber !== "all") {
                results = results.filter({
                    "SowingForm.useEffect": (f)=>f.farm.toString() === selectedFarmNumber
                }["SowingForm.useEffect"]);
            }
            if (activeTab !== "all") {
                results = results.filter({
    ...
    /* ===================== STATS ===================== */ const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SowingForm.useMemo[stats]": ()=>{
            ...
            const allVarieties = farmData.flatMap({
                "SowingForm.useMemo[stats].allVarieties": (f)=>f.variety.split(",").map({
                        "SowingForm.useMemo[stats].allVarieties": (v)=>v.trim()
                    }["SowingForm.useMemo[stats].allVarieties"]).filter(Boolean)
            }["SowingForm.useMemo[stats].allVarieties"]);
            ...
            const farmsWithSeedTreatment = farmData.filter({
                "SowingForm.useMemo[stats]": (f)=>f.seed_treatment
            }["SowingForm.useMemo[stats]"]).length;
            // Farms with soil conditioner
            const farmsWithSoilConditioner = farmData.filter({
                "SowingForm.useMemo[stats]": (f)=>f.soil_conditioner
            }["SowingForm.useMemo[stats]"]).length;
            // Farms with fertilizers
            const farmsWithFertilizers = farmData.filter({
                "SowingForm.useMemo[stats]": (f)=>f.basal_fertilizers_applied && f.basal_fertilizers_applied.length > 0
            }["SowingForm.useMemo[stats]"]).length;
            return {
                total,
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        selectedFarm.max_temp_day !== null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "space-y-1",
                                                                        children: Array.isArray(selectedFarm.aphid_recommendation) ? selectedFarm.aphid_recommendation.map((rec, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=components_stage-forms_sowing-form_tsx_5839d802._.js.map