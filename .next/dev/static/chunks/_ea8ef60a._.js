...
function FarmOverview() {
    const farms = [
        {
            id: 1,
            name: "Cholistani Pasture Farm",
            location: "Cholistan, Chapu Area, Bahawalpur, Punjab",
            area: "150 acres",
            status: "Active",
            weather: {
                temp: 32,
    ...
    const alerts = [
        {
            ...
            description: 'Green Valley Farm requires irrigation',
...
//# sourceMappingURL=_ea8ef60a._.js.map